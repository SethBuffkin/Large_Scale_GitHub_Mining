...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Github Miner | Issues</title>
...
if ($committed){$csvdata['title']= $committed;}
...
if ($committed){$jsondata['title']= $committed;}
?>
                                <li><a href="issues_export.php?<?php echo http_build_query($csvdata) ?>" ><i class="fa fa-angle-double-right"></i> CSV</a></li>								
                                <li><a href="issues_export.php?<?php echo http_build_query($jsondata) ?>" ><i class="fa fa-angle-double-right"></i> JSON</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
...
<?php  } ?>    					
				...
				<form role="form" method="get" action="issues_list.php" >
				<div class="box-body">
                                <label>Filter issues:</label>
				<input class="form-control input-lg" name="title" type="text" placeholder="Word or phrase in issue message">
				</div>
