                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="./pages/simple_data.php"><i class="fa fa-angle-double-right"></i> Simple</a></li>
                                <li><a href="./pages/verbose_data.php"><i class="fa fa-angle-double-right"></i> Verbose</a></li>
                            </ul>
                        </li>
                        <!-- <li>
            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    ...
                    <div class="box box-info">
                                ...
                                <div class="box-body">
                                    <input class="form-control input-lg" type="text" placeholder="Keywords">
                                    <br/>
                                    <a href="./pages/query.html"><p>
                                    More Search Options
                                    </p></a>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
...
<!--                                         </tr> -->
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a href="./pages/simple_data.html"><h3 class="box-title">Mined Project Data</h3></a>                                    
                                </div><!-- /.box-header -->
